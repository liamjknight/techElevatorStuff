...
public class Exercises {
	...
	public boolean nearTen(int num) {
		return ((num % 10 > 7) || (num % 10 < 3))?true:false;
	}
	...
	public boolean inOrder(int a, int b, int c, boolean bOk) {
		return (bOk)?(b<c)?true:false:(a<b&&b<c)?true:false;//bOk conditional splits into two more ternarys
	}
