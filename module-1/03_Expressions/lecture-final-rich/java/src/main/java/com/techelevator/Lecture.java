...
public class Lecture {
    ...
    */
    public int returnNumberAfterAddThreeAndAddFive(int number, boolean addThree, boolean addFive) {
    	...
    	// This ensures that when both parameters are true they can be acted upon
    ...
    */
    public String returnAdultOrMinorOrTeen(int number) {
        ...
        //I can evaluate the mutually exclusive Adult or Teen conditions
		if (number > 17) {
			result = "Adult";
		} else if (number >= 13) {
			result = "Teen";
		...
		//Return the result variable. Because it is defaulted 
		return result;
    }
