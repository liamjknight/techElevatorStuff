...
public class Exercises {
	...
	public static void main(String[] args) {
        ...
        */
        ...
        int dimeCount = 1;
        int nickelCount = 2;
        float totalCents = (quarterCount * 0.25f) + (dimeCount * .10f) + (nickelCount * .05f);
        ...
        */
        ...
        float totalSpent = yoyoCost + whistleCost;
        ...
        */
        float startingMoney = 10f;
        float toyTruckCost = 3f;
        float pencilCost = 2f;
        float remainingMoney = startingMoney - (toyTruckCost + pencilCost);
        ...
        */
        ...
        cream cones cost?
        */
        float singleConeCost = .99f;
        float totalConeCost = 2 * singleConeCost;
        ...
        */
        ...
        float totalSpentOn6Dogs = 6 * costPerHotDog;
        ...
        */
        float candyCost = .540f;
        float change = ((float)(1.000)) - candyCost;
        ...
        */
        ...
        left?
        */
        float startingCash = 3.00f;
        float candyBarCost = 1.00f;
        float remainingCash = startingCash - candyBarCost;
